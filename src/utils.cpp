...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/06/05 12:51:59 by doduwole          #+#    #+#             */
/*   Updated: 2024/06/07 23:09:44 by drey             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
const std::string b64decode(const void *data, const size_t &len) {
  ...
  for (size_t i = 0; i < last; i += 4) {
    int n = B64index.at(p[i]) << 18 | B64index.at(p[i + 1]) << 12 |
...
template void printVec<std::string>(const std::vector<std::string> &value,
                                    const std::string &callingFunction);
template void printVec<int>(const std::vector<int> &value,
                            const std::string &callingFunction);
