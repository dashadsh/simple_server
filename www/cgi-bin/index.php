...
<header class="masthead d-flex align-items-center">
    <div class="container px-4 px-lg-5 text-center">
        ...
        <h3 class="" style="text-align: center; width: 30pc; justify-content: center; margin: 20px auto;"><em></em></h3>
    ...
    <div class="container px-4 px-lg-5 text-center">
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-lg-10">
                ...
                <p class="lead mb-5">
                    We are utilizing epoll for event-driven I/O, handles HTTP requests and CGI scripts, providing low-level control for high-performance web serving
                    <a href="">Github</a>
                    !
                </p>
    ...
    <div class="container px-4 px-lg-5">
        ...
        <div class="row gx-4 gx-lg-5">
            <div class="col-lg-4 col-md-6 mb-5 mb-lg-0">
                <span class="service-icon rounded-circle mx-auto mb-3"><img src="../assets/img/dareoduwole.webp" alt=""></span>
            ...
            <div class="col-lg-4 col-md-6 mb-5 mb-md-0">
                <span class="service-icon rounded-circle mx-auto mb-3"><img src="../assets/img/my_picture.webp" alt=""></span>
                <h4 class="text-dark"><strong>Mohammed Elkholy</strong></h4>
                <div class="social-icons">
                    <a href="https://github.com/SolarisCode" target="_blank" class="icon">
                      <i class="fab fa-github"></i>
                    </a>
                    <a href="https://www.linkedin.com/in/mohammed-seifelislam-elkholy/" target="_blank" class="icon">
                      <i class="fab fa-linkedin"></i>
                    </a>
                </div>    
            </div>
